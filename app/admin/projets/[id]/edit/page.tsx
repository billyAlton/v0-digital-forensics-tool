...
export default function EditProjectPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await ProjectService.updateProject(projectId, cleanedData);
    ...
    // Fonction pour nettoyer les données (identique à la création)
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Button variant="outline" size="sm" onClick={() => router.push("/admin/projets")}>
                        <ArrowLeft className="mr-2 h-4 w-4" />
                        Retour
                    </Button>
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Modifier le Projet</h1>
                        <p className="text-gray-600 mt-1">Modifiez les informations du projet</p>
                    </div>
                </div>
            </div>
