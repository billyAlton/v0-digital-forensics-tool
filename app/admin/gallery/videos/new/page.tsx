// app/admin/galerie/videos/new/page.tsx
"use client"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Nouvelle Vidéo</h1>
            <p className="text-gray-600 mt-1">Ajoutez une nouvelle vidéo à la galerie</p>
          </div>
        </div>
      </div>
