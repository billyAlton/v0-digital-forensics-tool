// app/admin/galerie/albums/new/page.tsx
"use client"
...
export default function NewAlbumPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await GalleryService.createAlbum(cleanedData)
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Créez un nouvel album photo pour la galerie</p>
          </div>
        </div>
      </div>
